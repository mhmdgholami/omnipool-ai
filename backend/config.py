...
class Settings:
    ...
    x_query: str = os.getenv("X_QUERY", '(meme OR viral OR trending OR launch) -is:retweet lang:en')
    reddit_client_id: str = os.getenv("REDDIT_CLIENT_ID", "")
    reddit_client_secret: str = os.getenv("REDDIT_CLIENT_SECRET", "")
    reddit_user_agent: str = os.getenv("REDDIT_USER_AGENT", "omnipool-ai/0.2")
    news_rss_url: str = os.getenv("NEWS_RSS_URL", "https://news.google.com/rss?hl=en-US&gl=US&ceid=US:en")
