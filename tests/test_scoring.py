...
def test_less_saturation_scores_better():
    low_saturation = TrendFeatures(80, 70, 70, 80, 5, 80, 90)
    high_saturation = TrendFeatures(80, 70, 70, 80, 80, 80, 90)

    assert compute_trend_score(low_saturation) > compute_trend_score(
        high_saturation
    )
